                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtInputMa)
                                .addComponent(txtInputTen, javax.swing.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE)))))
...
private void loadTable() {
        List<ChucVuDTO> list = chucVuService.getChucVu();
    ...
    private ChucVuDTO getChucVuFormInput() {
    ...
    private String getChucVuIDFormSelectRow() {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ChucVuDTO chucVuDTO = getChucVuFormInput();
        if (chucVuService.creatNewChucVu(chucVuDTO) != null) {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        ChucVuDTO updateChucVu = getChucVuFormInput();
        String updateChucVuID = getChucVuIDFormSelectRow();
        updateChucVu.setId(updateChucVuID);
        if (chucVuService.updateChucVuById(updateChucVu) != null) {
            JOptionPane.showMessageDialog(this, "thanh cong");
        } else {
            JOptionPane.showMessageDialog(this, "That Bai");
        }
...
int row = this.jTable1.getSelectedRow();
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        if (chucVuService.deleteChucVuById(getChucVuIDFormSelectRow())) {
